<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true" v-if="bike">
      <ion-item>
        <ion-icon aria-hidden="true" :icon="personCircle" color="primary"></ion-icon>
        <div :class="bike.locked ? 'dot dot-locked' : 'dot dot-unlocked'"></div>
...
const bike = getBike(parseInt(route.params.id as string, 10));
</script>
